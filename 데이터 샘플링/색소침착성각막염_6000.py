...
# 경로 설정
folder_a = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\데이터셋\TL1_개_안구_일반\색소침착성각막염\유"
folder_b = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\데이터셋\VL_개_안구_일반\색소침착성각막염\유"
target_folder = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\최종 데이터셋\색소침착성각막염"
