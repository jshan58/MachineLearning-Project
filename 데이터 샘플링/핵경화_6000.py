...
# 경로 설정
folder_a = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\데이터셋\TL2_개_안구_일반\핵경화_유\유"
folder_b = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\데이터셋\VL_개_안구_일반\핵경화\유"
target_folder = r"C:\Users\minar\OneDrive\바탕 화면\학교\Machine Learning\팀프로젝트\최종 데이터셋\핵경화"
